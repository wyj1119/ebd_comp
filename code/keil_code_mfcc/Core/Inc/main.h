...
#define BEEP_OPEN HAL_GPIO_WritePin(GPIOC,GPIO_PIN_8,GPIO_PIN_SET)
#define BEEP_CLOSE HAL_GPIO_WritePin(GPIOC,GPIO_PIN_8,GPIO_PIN_RESET)
#define BEEP_Toggle HAL_GPIO_TogglePin(GPIOC,GPIO_PIN_8)
