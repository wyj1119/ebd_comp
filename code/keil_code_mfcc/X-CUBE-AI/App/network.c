...
#define AI_NETWORK_MODEL_SIGNATURE     "8f2f5501bb516eefceb041275c3929d6"
...
#define AI_TOOLS_DATE_TIME   "Mon Jul 10 22:29:25 2023"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0, 0x0,
  AI_SHAPE_INIT(4, 1, 32, 12, 8), AI_STRIDE_INIT(4, 4, 4, 128, 1536),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  2, 0x0,
  AI_SHAPE_INIT(4, 1, 64, 3, 2), AI_STRIDE_INIT(4, 4, 4, 256, 768),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  15, 0x0,
  AI_SHAPE_INIT(4, 1, 1, 48, 32), AI_STRIDE_INIT(4, 4, 4, 4, 192),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  17, 0x0,
  AI_SHAPE_INIT(4, 1, 16, 24, 16), AI_STRIDE_INIT(4, 4, 4, 64, 1536),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 93964, 1, 1),
    93964, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    conv2d_0_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 6144);
    conv2d_0_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 6144);
    
    conv2d_0_output_array.data = AI_PTR(g_network_activations_map[0] + 12288);
    conv2d_0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 12288);
    ...
    conv2d_2_output_array.data = AI_PTR(g_network_activations_map[0] + 8832);
    conv2d_2_output_array.data_start = AI_PTR(g_network_activations_map[0] + 8832);
    ...
    conv2d_4_output_array.data = AI_PTR(g_network_activations_map[0] + 3072);
    conv2d_4_output_array.data_start = AI_PTR(g_network_activations_map[0] + 3072);
    ...
    dense_7_output_array.data = AI_PTR(g_network_activations_map[0] + 256);
    dense_7_output_array.data_start = AI_PTR(g_network_activations_map[0] + 256);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    conv2d_2_bias_array.data = AI_PTR(g_network_weights_map[0] + 0);
    conv2d_2_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 0);
    
    conv2d_4_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_4_weights_array.data = AI_PTR(g_network_weights_map[0] + 128);
    conv2d_4_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 128);
    
    conv2d_4_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_4_bias_array.data = AI_PTR(g_network_weights_map[0] + 73856);
    conv2d_4_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 73856);
    
    dense_7_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_7_weights_array.data = AI_PTR(g_network_weights_map[0] + 74112);
    dense_7_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 74112);
    
    dense_7_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_7_bias_array.data = AI_PTR(g_network_weights_map[0] + 74880);
    dense_7_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 74880);
    
    conv2d_0_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_0_weights_array.data = AI_PTR(g_network_weights_map[0] + 74892);
    conv2d_0_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 74892);
    
    conv2d_0_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_0_bias_array.data = AI_PTR(g_network_weights_map[0] + 75468);
    conv2d_0_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 75468);
    
    conv2d_2_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_2_weights_array.data = AI_PTR(g_network_weights_map[0] + 75532);
    conv2d_2_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 75532);
